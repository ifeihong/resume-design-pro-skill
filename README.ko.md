...
<!-- 키워드: AI 이력서 생성기, CV 생성기, 이력서 작성, 전문 이력서 템플릿, HTML 이력서, PDF 이력서 낳은내기, ATS 호환 이력서, 자기소개서 생성기, 프로필 최적화, 구직 전략, 면접 준비, 이력서 진단, JD 매칭, 다국어 이력서, 이중언어 CV -->
...
| `profile-export.html` | 언어 타겟형 프로필 최적화 -- 이력서 언어에 따라 자동 출력: 중국어(Boss直聘/51job), 영어(LinkedIn/Indeed), 일본어(리쿠나비/마이나비), 한국어(잡코리아/사람인). 복사하여 바로 사용 |
