...
<!-- 关键词：AI 简历生成器, CV 生成器, 简历制作, 专业简历模板, HTML 简历, PDF 简历导出, ATS 兼容简历, 求职信生成器, 招聘平台资料优化, 求职策略, 面试准备, 简历诊断, JD 匹配, 多语言简历, 双语简历 -->
...
| `profile-export.html` | 招聘平台资料优化 -- 按简历语言自动输出对应平台：中文(Boss直聘/51job)、英文(LinkedIn/Indeed)、日文(リクナビ/マイナビ)、韩文(잡코리아/사람인)，一键复制 |
